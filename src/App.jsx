        ...
        {showingDetail ? (
          ...
          <>
            ...
            <div className="scroll">
              ...
              {section === "programs" && <ProgramsSection onApplyToStudent={(session) => setApplyTarget(session)} />}
...
function ProgramsSection({ onApplyToStudent }) {
  const [programId, setProgramId] = useState("pro-masse");
  const [openSession, setOpenSession] = useState(null);
  const program = PROGRAM_LIBRARY[programId];
  return (
    <>
      <div className="sec-head"><h2>Bibliothèque de programmes</h2></div>
